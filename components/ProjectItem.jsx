...
const ProjectItem = ({ title, desc, backgroundImg, projectUrl }) => {
  return (
    <div>
        <div className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl p-2 sm:p-4 group hover:bg-gradient-to-r from-[#bba6f5] to-[#9981db]">
